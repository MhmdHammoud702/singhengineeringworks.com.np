      ...
      <div className='flex-1'>
        ...
        <ul className='space-y-3'>
          ...
          <li className="flex items-center hover:text-[#77c720] cursor-pointer text-lg">
            ...
            <a href="tel:+9779816340067">+977 9816340067</a>
          </li>
          <li className="flex items-center hover:text-[#77c720] cursor-pointer text-lg">
            <img src="/assets/images/contact/mail.png" alt="email" className="w-6 h-6 mr-2" /> <a href="mailto:arvindpalsingh269@gmail.com">arvindpalsingh269@gmail.com</a>
